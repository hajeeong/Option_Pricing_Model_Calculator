...
if __name__ == "__main__":
    ...
    call_price, paths = monte_carlo_option_pricing("Call", S0, K, sigma, r, T, num_simulations)
    put_price, _ = monte_carlo_option_pricing("Put", S0, K, sigma, r, T, num_simulations)
